package studentManageSystem.com.zse.view;
...
import studentManageSystem.com.zse.controller.Controller;
...
public class AdminFrame extends JFrame{
	...
	public static final String CHECK_STUDENT_INFO = "查看学生信息";
	public static final String ADD_STUDENT_INFO = "添加学生信息";
	public static final String MODIFY_DELETE_STUDENT_INFO = "修改/删除学生信息";
	public static final String ADD_COURSE = "添加课程";
	public static final String MODIFY_DELETE_COURSE = "修改/删除课程";
	public static final String EDIT_STUDENT_SCORE = "编辑学生成绩";
